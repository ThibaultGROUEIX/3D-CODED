...
class Experiments(object):
    def __init__(self):
        self.inference = {
            0: "python inference/script.py --dir_name learning_elementary_structure_trained_models/0point_translation --HR 1",
            1: "python inference/script.py --dir_name learning_elementary_structure_trained_models/1patch_deformation --HR 1",
            2: "python inference/script.py --dir_name learning_elementary_structure_trained_models/2point_translation_and_patch_deformation --HR 1",
            3: "python inference/script.py --dir_name learning_elementary_structure_trained_models/3D_CODED --HR 1",
        }
        self.trainings = {
